...
@app.on_callback_query(filters.regex("ChizurumousAdmin") & ~BANNED_USERS)
async def Chizurumous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("ChizuruPlaylists") & ~BANNED_USERS)
@languageCB
